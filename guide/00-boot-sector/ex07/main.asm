...
; максимальный размер регистров = 16 битов, поэтому самый большой размер, 
...
; значение сегмента ds как 0x4d и попробуем сделать что-то вроде mov ax, [0x20],
; то значение, добавляемое в ax, будет загружено из адреса 0x4d0
; (16 * 0x4d + 0x20).
