...
;			выводит на экран строку с помощью функции
; ------------------------------------------------------------------------------
; Description:
...
;	регистра EIP (адрес, следующий после call <метка> инструкции) в стек, а 
;	команда ret извлекает его и передаёт управление инструкции по этому адресу. 
;	Вы также можете определить аргументы, для вызываемой функции. 
;	Это можно сделать с помощью стека или регистров, т.е. перед вызовом функции 
;	занести параметры в стек или в определенный регистр, а в теле функции 
;	извлечь их.
; ------------------------------------------------------------------------------
