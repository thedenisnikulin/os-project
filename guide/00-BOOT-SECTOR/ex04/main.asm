...
;	Вы также можете определить аргументы, для вызываемой программы (процедуры). 
;	Это можно сделать через стек, т.е. перед вызовом функции занести в стек 
;	параметры, а в теле функции извлечь их.
; ------------------------------------------------------------------------------
